...
<template>
  <div class="logo_and_menu">
    ...
    <div class="divider" />
    <div class="menu">
      <router-link to="/categorias"> <i class="icon mdi mdi-engine" /> Categorias </router-link>
    </div>
    <div class="menu">
      <router-link to="/manufactores"> <i class="icon mdi mdi-factory" /> Fabricantes </router-link>
    </div>
  </div>
  <logo-title />
</template>
